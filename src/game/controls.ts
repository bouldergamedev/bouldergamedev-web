...
export const touchHelp = {
	ready: 'Hold ← → to move · ↑ to jump · Hook fires 45° forward; tap again to launch.',
	swinging: 'Hold ← → to swing · ↑ pulls cable in / ↓ lets it out · Launch or release with the buttons.',
};
